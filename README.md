...
6. Реализовать простейший консольный интерфейс для взаимодействия с системой. Достаточно реализовать добавление/удаление данных и вызов той логики, которая описана по заданию. Данные можно грузить из файла. 
