...
6. Реализовать простейший консольный интерфейс для добавления/удаления данных и пользовательского ввода, если это требуется. Как альтернатива, данные можно загружать в программу из файла. 
